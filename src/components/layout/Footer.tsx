          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm text-stone-400">
                ...
                <a to="tel:0984272727" className="hover:text-amber-400 transition-colors">0984 272 727</a>
              </li>
              <li className="flex items-center gap-2 text-sm text-stone-400">
                <Mail size={14} className="text-amber-500" />
                <a to="mailto:info@zelanfurniture.com" className="hover:text-amber-400 transition-colors">info@zelanfurniture.com</a>
              </li>
            </ul>
            {/* Social */}
            <div className="flex gap-3 mt-4">
              <a to="#" className="w-8 h-8 bg-stone-700 rounded-full flex items-center justify-center hover:bg-amber-700 transition-colors" aria-label="Facebook">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a to="#" className="w-8 h-8 bg-stone-700 rounded-full flex items-center justify-center hover:bg-amber-700 transition-colors" aria-label="Instagram">
              ...
              <a to="#" className="w-8 h-8 bg-stone-700 rounded-full flex items-center justify-center hover:bg-amber-700 transition-colors" aria-label="TikTok">
