        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-stone-900 leading-tight mb-5">
              Luxury Furniture
              <span className="block text-amber-700">Crafted for</span>
              <span className="block">Modern Living</span>
            </h1>
            <p className="text-stone-500 text-lg mb-8 max-w-md leading-relaxed">
              Discover premium furniture collections for every room. 4 showrooms across Addis Ababa, with fast delivery and custom orders.
            </p>
